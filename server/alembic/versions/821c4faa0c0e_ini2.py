...
Revision ID: 821c4faa0c0e
Revises: 474f14b269e0
Create Date: 2024-11-06 13:21:50.631145
...
revision = '821c4faa0c0e'
down_revision = '474f14b269e0'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.add_column('groups', sa.Column('id_group', sa.INTEGER(), autoincrement=True, nullable=False))
    ...
    sa.Column('id_professor', sa.INTEGER(), server_default=sa.text("nextval('professors_id_professor_seq'::regclass)"), autoincrement=True, nullable=False),
